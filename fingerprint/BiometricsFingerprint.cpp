...
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.0-service.samsung_8976"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.0-service.samsung_8976"
    ...
    switch (msg->type) {
        ...
        case FINGERPRINT_TEMPLATE_ENROLLING:
            ...
            if (!thisPtr->mClientCallback->onEnrollResult(devId,
                    msg->data.enroll.finger.fid,
                    msg->data.enroll.finger.gid,
                    100 - msg->data.enroll.samples_remaining).isOk()) {
